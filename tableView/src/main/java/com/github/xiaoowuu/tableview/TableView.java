...
public class TableView extends ViewGroup implements GestureDetector.OnGestureListener {
    ...
    private void preMeasureAllCell() {
    ...
    public View getCellView(Context context, int column, int row) {
        View view = null;
        ...
        if (view == null) {
            view = adapter.createCellView(context, column, row);
            array.put(row, view);
            views.put(column, array);
        }
        return view;
    }
    ...
    public void notifyCellChanged(int column, int row) {
        ...
        if (array != null) {
            ...
            view.layout(oldView.getLeft(), oldView.getTop(), oldView.getRight(), oldView.getBottom());
            addView(view, 0);
        }
    }
    ...
    public static class PreviewAdapter extends Adapter implements OnClickListener {

        private String[][] data = {
                {"阿萨斯大所多", "阿萨德的发", "嘘嘘", "阿斯达撒旦阿达萨达", "本色股份大声道", "水电费跟我说", "东方故事东方大道", "东方故事东方大道", "东方故事东方大道", "东方故事东方大道", "阿萨斯大所多", "阿萨德的发", "嘘嘘", "阿斯达撒旦阿达萨达", "本色股份大声道", "水电费跟我说", "东方故事东方大道", "东方故事东方大道", "东方故事东方大道", "东方故事东方大道"},
                {"阿萨斯大所多", "阿萨德的发", "嘘嘘", "阿斯达撒旦阿达萨达", "本色股份大声道", "水电费跟我说", "东方故事东方大道", "东方故事东方大道", "东方故事东方大道", "东方故事东方大道", "阿萨斯大所多", "阿萨德的发", "嘘嘘", "阿斯达撒旦阿达萨达", "本色股份大声道", "水电费跟我说", "东方故事东方大道", "东方故事东方大道", "东方故事东方大道", "东方故事东方大道"},
                {"阿萨斯大所多", "阿萨德的发", "嘘嘘", "阿斯达撒旦阿达萨达", "本色股份大声道", "水电费跟我说", "东方故事东方大道", "东方故事东方大道", "东方故事东方大道", "东方故事东方大道", "阿萨斯大所多", "阿萨德的发", "嘘嘘", "阿斯达撒旦阿达萨达", "本色股份大声道", "水电费跟我说", "东方故事东方大道", "东方故事东方大道", "东方故事东方大道", "东方故事东方大道"},
                {"阿萨斯大所多", "阿萨德的发", "嘘嘘", "阿斯达撒旦阿达萨达", "本色股份大声道", "水电费跟我说", "东方故事东方大道", "东方故事东方大道", "东方故事东方大道", "东方故事东方大道", "阿萨斯大所多", "阿萨德的发", "嘘嘘", "阿斯达撒旦阿达萨达", "本色股份大声道", "水电费跟我说", "东方故事东方大道", "东方故事东方大道", "东方故事东方大道", "东方故事东方大道"},
                {"阿萨斯大所多", "阿萨德的发", "嘘嘘", "阿斯达撒旦阿达萨达", "本色股份大声道", "水电费跟我说", "东方故事东方大道", "东方故事东方大道", "东方故事东方大道", "东方故事东方大道", "阿萨斯大所多", "阿萨德的发", "嘘嘘", "阿斯达撒旦阿达萨达", "本色股份大声道", "水电费跟我说", "东方故事东方大道", "东方故事东方大道", "东方故事东方大道", "东方故事东方大道"},
    ...
    private static class MeasureTask extends AsyncTask<Void, Void, Void> {

        private WeakReference<TableView> reference;

        public MeasureTask(TableView tableView) {
            reference = new WeakReference<>(tableView);
        }

        @Override
        protected Void doInBackground(Void... voids) {
            TableView tableView = reference.get();
            long start = System.currentTimeMillis();
            if (tableView != null) {
                tableView.preMeasureAllCell();
            }
        ...
        protected void onPostExecute(Void aVoid) {
            ...
            long start = System.currentTimeMillis();
            if (tableView != null) {
                tableView.addAllCellView();
            }
            System.out.println("addView:" + (System.currentTimeMillis() - start));
        }
    }
